...
<br>The code is useful for ML students to preview some essential ANN algorithms from scratch ;) 🍿🍿🍿</br>

Algorithms such as:
<ul>

<li> 2D Convolution (Numba accelerated)</li>
<li> Softmax </li>
<li> Backpropagation / Chain Rule </li>
<li> Adam Optimisation </li>
<li> Auto-Initialisation (e.g. ReLU -> Kaiming; Softmax -> Xavier) </li>
...
<br>(see license.md or visit https://creativecommons.org/licenses/by-nc-sa/4.0/)</br>

##
<strong>Thanks for reading❗️😄</strong>
<br>If my work was useful in anyway, please support it with a star ⭐️👍</br>
